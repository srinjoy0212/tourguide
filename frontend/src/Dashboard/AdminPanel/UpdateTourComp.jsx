...
const UpdateTours = ({ tour, id }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    distance: 0,
    featured: false,
    schedule: [{ day: "", description: "", location: "" }], // Initial empty schedule row
    includedInPackage: "",
    excludedInPackage: "",
    importantInfo: "",
  });
  ...
  useEffect(() => {
    if (tour) {
      ...
      setFormData((prevData) => ({
        ...
        excludedInPackage: excludedInPackage || "",
  ...
  const handleInput = (e) => {
    ...
    // If the name is 'featured', convert the string to a boolean
    if (name === "featured") {
      setFormData({ ...formData, [name]: value === "true" }); // Convert to boolean
    } else {
        ...
        <div className="flex flex-col justify-center">
          <div className="text-center mb-6">
            ...
            <p className="text-sm md:text-base text-GrayColor">
              Update the tour details by filling in the fields.
            </p>
          </div>
