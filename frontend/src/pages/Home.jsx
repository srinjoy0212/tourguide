...
const Home = () => {
  ...
  <div className="my-8">
    ...
    <p className="text-lg leading-8 text-gray-800 hidden md:block">
      "Welcome to Shivam Travels, your ultimate partner for unforgettable journeys! 
      Explore breathtaking destinations, plan effortlessly, and set out on the adventure of your dreams. 
      Find exceptional accommodations, meet like-minded explorers, and craft memories to cherish forever. 
      Your next incredible trip starts with Shivam Travels!"
    </p>
